...
<html>
    ...
    <!-- Body -->
	<body onload="loadmap()">
     <s:form theme="simple" method="post" style="margin-bottom: 0em;" action="#" >
    <div id="wrapper" style="padding-top: 0em; background-color: white;">
   	<input type="hidden" id="availableCoupon" name="availableCoupon" value='<s:property value="availableCoupon" />'/>	
		<input type="hidden" name="passbookUrl" id="passbookUrl" value='<s:property value="passbookUrl"/>' />
		<input type="hidden" name="couponUrl" id="couponUrl" value='<s:property value="couponUrl"/>' />
        <!-- Header -->
        <Center style="padding-left: 0.5em; padding-right: 0.5em; margin-top: -0.5em;">
            ...
            <h5 style="color: #000000"><s:property value="merchantName"/></h5>
        </Center>
        ...
        <!-- Coupon Name -->
        <center>
            <h3 style="color: #000000; background-color: white; margin-top: 0em; margin-bottom: -0.5em; padding: 0.8em;"><s:property value="campaignName"/></h3>
         	 <s:if test="%{availableCoupon == 0}">
         	<h4 style="color:red;margin-bottom: 0em">Full Redeemed!</h4>
         	</s:if>
           <s:if test="%{campaignType == \"C\"}">
            <p style="color: #000000; background-color: white; height:1px;font-size: 22px;font-weight: bold;"><s:property value="currency"/><s:property value="getText('{0, number, $ ##0.00}', {sellingPrice })"/></p>
            <p style="color: #000000; background-color: white;  height:1px;font-size: 16px;font-weight: bold;"><s:property value="currency"/><strike><s:property value="getText('{0, number, $ ##0.00}', {orginalprice})"/></strike></p>
          </s:if>
        </center>
        <!-- Coupon Border -->
        <img src="images/border.png" style="width: 100%; background-color: #000000; margin-bottom: -1em;">
        
        <!-- Main -->
        <div id="main" style="background-color: #000000;">
            ...
            <section id="coupon">
				...
				<div class="inner" style="padding: 1.5em 0 1em 0;">
                    ...
                    <select name="customerDate" id="customerDate" style="background-color: white;color: black !important;text-align: center;margin-bottom: 0.5em;">
						<option value="0">Birthday 生日日期 – Day 日</option>
				...
				<select name="customerMonth" id="customerMonth" style="background-color: white; color: black !important; text-align: center; margin-bottom: 0.5em;border-color:black">
						<option value="0">Birthday 生日日期 – Month 月</option>
						<option value="01">01</option>
							<option value="02">02</option>
							<option value="03">03</option>
							<option value="04">04</option>
          ...
          <%--           <br>
                    ...
                    <center><label for="email" id="emaillbl">Coupon via Email 電郵獲取優惠卷</label></center>
                     <div id="butdiv" style="display:block">
                    ...
                    <div style="padding-top: 10px;">
                        ...
                        <label for="accpet-terms-2">
                            <span class="label">
                                本人同意OPTICAL 88使用本人的個人資料進行其私隱政策聲明內所載的直接促銷用途。OPTICAL 88可向本人寄送通訊、市場營銷和推廣宣傳資料，直至本人另行通知。
                            </span>
                        </label>
                    </div>

                    <hr style="border-color: white; border-width: thin;">
                    ...
                    <details>
                        <summary><h4 style="display: inline; vertical-align: middle;"> Terms and Conditions 條款及細則</h4></summary>
                        
                        <textarea id="campaignTc" name="campaignTc"	rows="5" class="form-control" readonly="true" style="background-color: #000000;"><s:property value="campaignTc" /></textarea>
                    </details>
                    ...
                    <details>
                        ...
                        <section class="spotlights">
                            <br />
                            <section id="listing" style="background-color: #000000;">
                            <s:iterator value="siteslist" status="sitelst" >
                            
                                <div class="4u 12u$(medium)" style="padding: 0.5em;">
                                    <center class="box" style="border: solid 1px #ffffff;">
