...
public class CampaignData {
	...
	private List<CampaignSiteModel> redemsites;
	...
	public List<CampaignSiteModel> getRedemsites() {
		return redemsites;
	}

	public void setRedemsites(List<CampaignSiteModel> redemsites) {
		this.redemsites = redemsites;
	}
